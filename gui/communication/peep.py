...
class peep:
    ...
    def __init__(self):
        ...
        self.thePatient = Timer(.1, self.breath)
        self.thePatient.start()
    ...
    def delete(self):
        self.thePatient.cancel()

    def breath(self):
        self.inspiration()
        self.thePatient = Timer(self.config['sampling_interval'], self.breath)
        self.thePatient.start()
    ...
    def inspiration_duration(self):
        return self.breath_duration() * self.param['ratio']
    ...
    def inspiration(self):
        ...
        B = 0.95*self.param['peep_maximal_flow']
        tau = 0.1 * t1
