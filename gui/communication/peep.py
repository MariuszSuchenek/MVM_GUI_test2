...
class peep:
    ...
    def __init__(self):
        ...
        self.set('peep_maximal_pressure', 75)   # inpiration pressure in auto mode
    ...
    def breath(self):
        ...
        A = 0.95*(self.param['peep_maximal_pressure'] - self.p) # pressure amplitude
